...
/* Box stato backend (stesso di prima, ma minimale) */
    ...
    <>
      ...
      <main className="main">
        ...
        <p className="subtitle">
          Crea circuiti, gestisci piloti e campionati, avvia la gara con un click.
        </p>
    ...
    <BrowserRouter>
      <header className="topbar">
        ...
        {/* <nav className="topbar-nav">
          ...
          <Link className="nav-link" to="/piloti">Piloti</Link>
          <button className="nav-link" disabled>Impostazioni</button>
        </nav> */}
        <BackendStatusBox />
      </header>
